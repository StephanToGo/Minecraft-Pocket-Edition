...
use pocketmine\math\Vector3;
	...
	class antidoublechest extends PluginBase implements Listener{
		...
		public function onPlayerPlaceBlock(BlockPlaceEvent $event){
			...
			$bl = $event->getBlock()->getLevel();
			if ($blockID == 54){				
				$block1 = $bl->getBlock(new Vector3($bl->x+1,$bl->y,$bl->z));
				$block2 = $bl->getBlock(new Vector3($bl->x-1,$bl->y,$bl->z));
				$block3 = $bl->getBlock(new Vector3($bl->x,$bl->y,$bl->z+1));
				$block4 = $bl->getBlock(new Vector3($bl->x,$bl->y,$bl->z-1));
